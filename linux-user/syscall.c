...
static abi_long do_ioctl_autofs(const IOCTLEntry *ie, uint8_t *buf_temp,
                                int fd, abi_long cmd, abi_long arg)
{
    uint32_t size;
    void *argptr;
    ...
    if (get_user_u32(size, arg + 8))
        return -TARGET_EFAULT;

    argptr = lock_user(VERIFY_READ, arg, size, 0);
    if (!argptr)
        return -TARGET_EFAULT;

    ret = get_errno(ioctl(fd, ie->host_cmd, argptr));

    unlock_user(argptr, arg, size);

    return ret;
}

#define AUTOFS_DEV_IOCTL_VERSION 0xc0189371
#define TARGET_AUTOFS_DEV_IOCTL_VERSION AUTOFS_DEV_IOCTL_VERSION
#define AUTOFS_DEV_IOCTL_PROTOVER 0xc0189372
#define TARGET_AUTOFS_DEV_IOCTL_PROTOVER AUTOFS_DEV_IOCTL_PROTOVER
#define AUTOFS_DEV_IOCTL_PROTOSUBVER 0xc0189373
#define TARGET_AUTOFS_DEV_IOCTL_PROTOSUBVER AUTOFS_DEV_IOCTL_PROTOSUBVER
#define AUTOFS_DEV_IOCTL_OPENMOUNT 0xc0189374
#define TARGET_AUTOFS_DEV_IOCTL_OPENMOUNT AUTOFS_DEV_IOCTL_OPENMOUNT
#define AUTOFS_DEV_IOCTL_CLOSEMOUNT 0xc0189375
#define TARGET_AUTOFS_DEV_IOCTL_CLOSEMOUNT AUTOFS_DEV_IOCTL_CLOSEMOUNT
#define AUTOFS_DEV_IOCTL_READY 0xc0189376
#define TARGET_AUTOFS_DEV_IOCTL_READY AUTOFS_DEV_IOCTL_READY
#define AUTOFS_DEV_IOCTL_FAIL 0xc0189377
#define TARGET_AUTOFS_DEV_IOCTL_FAIL AUTOFS_DEV_IOCTL_FAIL
#define AUTOFS_DEV_IOCTL_SETPIPEFD 0xc0189378
#define TARGET_AUTOFS_DEV_IOCTL_SETPIPEFD AUTOFS_DEV_IOCTL_SETPIPEFD
#define AUTOFS_DEV_IOCTL_CATATONIC 0xc0189379
#define TARGET_AUTOFS_DEV_IOCTL_CATATONIC AUTOFS_DEV_IOCTL_CATATONIC
#define AUTOFS_DEV_IOCTL_TIMEOUT 0xc018937a
#define TARGET_AUTOFS_DEV_IOCTL_TIMEOUT AUTOFS_DEV_IOCTL_TIMEOUT
#define AUTOFS_DEV_IOCTL_REQUESTER 0xc018937b
#define TARGET_AUTOFS_DEV_IOCTL_REQUESTER AUTOFS_DEV_IOCTL_REQUESTER
#define AUTOFS_DEV_IOCTL_EXPIRE 0xc018937c
#define TARGET_AUTOFS_DEV_IOCTL_EXPIRE AUTOFS_DEV_IOCTL_EXPIRE
#define AUTOFS_DEV_IOCTL_ASKUMOUNT 0xc018937d
#define TARGET_AUTOFS_DEV_IOCTL_ASKUMOUNT AUTOFS_DEV_IOCTL_ASKUMOUNT
#define AUTOFS_DEV_IOCTL_ISMOUNTPOINT 0xc018937e
#define TARGET_AUTOFS_DEV_IOCTL_ISMOUNTPOINT AUTOFS_DEV_IOCTL_ISMOUNTPOINT
